...
from .views import main_view, login_view, signup_view, anonymous_login_view, chatPage, category_chat_view, logout_view, create_category_view, search_view
...
urlpatterns = [
    ...
    path('search/', search_view, name='search'),  # 서칭 뷰
]
